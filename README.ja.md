...
- 動画ファイルのモザイクを復元します。
- 静止画のモザイクを復元します。動画復元モデル（追加インストール不要）または実験的な SD 1.5 画像モデルを選べます。
...
- NVIDIA GPU では、オプションの[セカンダリ復元モデル](docs/ja/models.md) — **unet-4x**、**RTX Super Resolution**、**Topaz Video AI** — で品質をさらに高められます。復元した領域、とくに大きなモザイク、クローズアップ、4K 動画がシャープになります。現在、AMD ではセカンダリ復元を利用できません。
