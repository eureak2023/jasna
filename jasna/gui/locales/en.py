...
EN = {
        ...
        "tip_encoder_cq": "Video quality target (CQ). Lower numbers give better quality but larger files. Jasna also limits output size, so nearby values can give the same result when that limit is reached.\nNVIDIA starting values: 25 for H.264, 28 for HEVC, and 35 for AV1.",
